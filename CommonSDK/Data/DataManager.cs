...
namespace CommonSDK.Data
{
    ...
    public partial class DataManager : Singleton<DataManager>
    {
        ...
        /// <summary>
        /// 设置指定键的数据
        /// <para>触发事件：PlayerDataUpdated</para>
        /// </summary>
        /// <typeparam name="T">数据类型</typeparam>
        /// <param name="key">数据键</param>
        ...
        public void CreateNewSlot(string slotName)
        {
            ...
            if (file != null)
            {
                ...
                file.Close();
                EventBus.Instance.TriggerEvent(DataEvents.SlotCreated, slotName);
            }
        }

        /// <summary>
        /// 删除存档槽位
        /// <para>触发事件：SlotDeleted</para>
        /// </summary>
        /// <param name="slotName">槽位名称</param>
        public void DeleteSlot(string slotName)
        {
            ...
            if (FileAccess.FileExists(path))
            {
                ...
                EventBus.Instance.TriggerEvent(DataEvents.SlotDeleted, slotName);
            }
        }
        ...
        /// <summary>
        /// 切换到指定存档槽位
        /// <para>触发事件：SlotChanged, PlayerDataLoaded</para>
        /// </summary>
        /// <param name="slotName">槽位名称</param>
        public void SwitchSlot(string slotName)
        {
            ...
            LoadCurrentSlot();
            EventBus.Instance.TriggerEvent(DataEvents.SlotChanged, slotName);
        }
        ...
        public void ForceSave()
        {
            try
            {
                ...
                if (file != null)
                {
                    ...
                    EventBus.Instance.TriggerEvent(DataEvents.PlayerDataSaved, new
                    {
        ...
        /// <summary>
        /// 加载当前槽位的数据
        /// <para>触发事件：PlayerDataLoaded, PlayerDataError（加载失败时）</para>
        /// </summary>
        private void LoadCurrentSlot()
        {
            try
            {
                ...
                if (file != null)
                {
                    ...
                    EventBus.Instance.TriggerEvent(DataEvents.PlayerDataLoaded, new
                    {
                        SlotName = _currentSlot,
                        Data = _currentData
                    });
        ...
        {
            EventBus.Instance.TriggerEvent(DataEvents.PlayerDataUpdated, new DataUpdateEventArgs
            {
                SlotName = _currentSlot,
                Key = key,
                OldValue = oldValue,
        ...
        /// <summary>
        /// 处理错误
        /// <para>触发事件：PlayerDataError</para>
        /// </summary>
        /// <param name="message">错误信息</param>
        private void HandleError(string message)
        {
            _logger.LogError(message);
            EventBus.Instance.TriggerEvent(DataEvents.PlayerDataError, message);
        }
